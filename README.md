...
> **Ehrlicher Status:** Die Scripting-App 0.10.4 besitzt vier native Tabs und getrennte persistente Library-/Mod-/Payload-Speicher. love.js/LÖVE 11.5 und der Gen1Recomp-0.3.20-Payload bis `Module.postrun` sind auf dem echten Gerät **VERIFIZIERT**. Bit- und Lua-Load-Kompatibilität sowie ROM-Import sind bis zum Game-Boot vorgedrungen. Nach einem vollständigen statischen Lua-5.1-Kompatibilitätsdurchlauf korrigiert Runtime r9 den exakten Rail-Wrap-Randfall und persistiert frühe wie späte Runtimefehler. Gameplay bleibt **NICHT VERIFIZIERT**.
...
- [`docs/architecture/conformance-audit-0.3.0.md`](docs/architecture/conformance-audit-0.3.0.md) bis [`0.10.4`](docs/architecture/conformance-audit-0.10.4.md) — explizite Prüfungen jeder Iteration gegen die vereinbarte Architektur.
