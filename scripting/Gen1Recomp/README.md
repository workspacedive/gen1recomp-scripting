# Gen1Recomp Scripting Host 0.11.2
...
- ein ausdrücklich **experimenteller** Start pro erkanntem Library-ROM über den unveränderten `POKEPORT_IMPORT_ROM`-Pfad sowie ein nur dort aktivierter Multitouch-Controller für D-Pad, A, B, START und SELECT; Start und Eingabe sind geräteverifiziert, während Adapter r16 den beobachteten QueueableSource-Typbruch an der Runtimegrenze abfängt. Audio, Saves, Lifecycle und längeres Gameplay bleiben unbestätigt.
