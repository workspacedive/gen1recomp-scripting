# Gen1Recomp Scripting Host 0.10.5
...
- ein ausdrücklich **experimenteller** Start pro erkanntem Library-ROM über den unveränderten `POKEPORT_IMPORT_ROM`-Pfad sowie ein nur dort aktivierter Multitouch-Controller für D-Pad, A, B, START und SELECT; Gameplay, Eingabe, Audio, Saves und Lifecycle bleiben bis zum echten Gerätetest unbestätigt.
